import { w as head, x as attr, N as attr_style, J as ensure_array_like, y as stringify, O as await_block } from "../../../chunks/index2.js";
    ...
    for (let $$index_1 = 0, $$length = each_array.length; $$index_1 < $$length; $$index_1++) {
      ...
      for (let $$index = 0, $$length2 = each_array_1.length; $$index < $$length2; $$index++) {
        ...
        if (item.id === "neumorphism-demo") {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<a${attr("href", `${stringify(base)}/ultra/neumorphism-demo`)} class="block px-2 py-1.5 rounded-md hover:bg-accent hover:text-accent-foreground text-sm">${escape_html(item.name)}</a>`);
        } else {
          $$renderer2.push("<!--[!-->");
