<script lang="ts">
  ...
  onMount(async () => {
    // Import Ultra JS modules in correct order (basecoat.js first, then individual components)
...
<svelte:head>
  <title>Neumorphism Demo - Basecoat Ultra</title>
</svelte:head>
  ...
  <main class="flex-1 h-screen overflow-y-auto flex flex-col items-center relative z-10">
    ...
    <div class="flex-1 w-full flex flex-col items-center justify-center p-4">
      ...
      <div class="neu-flip-container w-full max-w-[400px] h-[550px]">
        ...
        <input type="checkbox" id="flip-toggle" class="neu-flip-toggle">
        ...
        <div class="neu-flip-inner neu-panel w-full h-full">
          ...
          <div class="neu-flip-face p-10 flex flex-col items-center">
            ...
            <form class="w-full space-y-6" onsubmit={() => event.preventDefault()}>
              <div class="neu-floating-group">
                <input type="text" id="login-user" class="neu-field" placeholder=" ">
                <label for="login-user">Username</label>
              </div>
              
              <div class="neu-floating-group">
                <input type="password" id="login-pass" class="neu-field" placeholder=" ">
                <label for="login-pass">Password</label>
              </div>

              <div class="pt-4">
                <button class="neu-btn w-full py-4 text-primary text-lg">
                  Sign In
                </button>
              </div>
            </form>
            ...
            <div class="mt-auto pt-6 text-center">
              <label for="flip-toggle" class="text-xs text-muted-foreground hover:text-primary hover:underline cursor-pointer transition-all">
          ...
          <div class="neu-flip-face neu-flip-back p-10 flex flex-col items-center bg-background rounded-[inherit]">
            ...
            <form class="w-full space-y-6" onsubmit={() => event.preventDefault()}>
              <div class="neu-floating-group">
                <input type="email" id="reg-email" class="neu-field" placeholder=" ">
                <label for="reg-email">Email Address</label>
              </div>
              
              <div class="neu-floating-group">
                <input type="password" id="reg-pass" class="neu-field" placeholder=" ">
                <label for="reg-pass">Choose Password</label>
              </div>
